    ...
    <form action="" method="POST">
        <div class="form-row">
            <div class="input-group">
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="first_name" placeholder="John" value="<?= isset($first_name) ? htmlspecialchars($first_name) : '' ?>" required>
                </div>
            </div>
            <div class="input-group">
                ...
                <div class="input-field">
                    <i class="fas fa-user"></i>
                    <input type="text" name="last_name" placeholder="Doe" value="<?= isset($last_name) ? htmlspecialchars($last_name) : '' ?>" required>
                </div>
            </div>
        </div>
        ...
        <div class="input-group">
            ...
            <div class="input-field">
                ...
                <input type="email" name="email" placeholder="john@example.com" value="<?= isset($email) ? htmlspecialchars($email) : '' ?>" required>
            </div>
        </div>
        ...
        <div class="input-group">
            ...
            <div class="input-field">
                ...
                <input type="text" name="phone" placeholder="07XXXXXXXX" maxlength="10" value="<?= isset($phone) ? htmlspecialchars($phone) : '' ?>" required>
            </div>
        </div>
